...
def replicas = "1"
def devProject = "elc-dev" // TODO: Your dev project name goes here
def testProject = "elc-test" // TODO: Your test project name goes here
def prodProject = "elc-prod"  // TODO: Your prod project name goes here
